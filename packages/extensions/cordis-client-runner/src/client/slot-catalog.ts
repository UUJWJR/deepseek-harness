...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, manual-compaction, model-retry, steering, tool-call, tool-call-compact, turn-error, turn-max-tokens, turn-tail, unknown, user, workflow-run',
    hookContext: 'string',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-tool-compact CompactModeRow id \'compact-mode\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-files FilesAction id \'files\'',
      'client-ui-report ReportGalleryAction id \'report-gallery\'',
